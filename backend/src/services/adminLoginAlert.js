...
<body style="font-family:-apple-system,Segoe UI,sans-serif;background:#f6f7f9;margin:0;padding:32px 16px;color:#111;">
  <div style="max-width:520px;margin:0 auto;background:#fff;border:1px solid #e5e7eb;padding:28px;">
    <div style="font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#6b7280;margin-bottom:8px;">Salon DZ Admin</div>
    ...
    <p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 20px 0;">
      Bonjour ${safeName},<br/>
      Une connexion vient d'avoir lieu sur votre compte administrateur Salon DZ.
    </p>
    ...
    <div style="margin-top:24px;padding:12px;background:#fef3c7;border-left:3px solid #f59e0b;font-size:12px;color:#78350f;">
      Si cette connexion ne vient pas de vous, changez immédiatement votre mot de passe et contactez l'équipe Salon DZ.
    </div>
  ...
  try {
    await sendEmail({
      to: adminEmail,
      subject: 'Connexion Salon DZ Admin',
      html,
    });
  } catch (e) {
