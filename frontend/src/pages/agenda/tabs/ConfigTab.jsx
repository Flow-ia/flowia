  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:14, paddingBottom:32 }}>
      ...
      <Section id="rules" title="Regles de reservation" bodyStyle={{ gap: 12 }}>
        ...
        {/* La politique d'annulation est editable UNIQUEMENT depuis
            /reglages/paiements pour eviter le doublon (meme champ DB
            cancellation_policy_hours edite a 2 endroits causait des
            ecrasements selon la page utilisee). On garde un raccourci ici. */}
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between',
          ...
          <div style={{ minWidth:0, flex:1 }}>
            ...
            <p style={{ margin:'2px 0 0', fontSize:11, color:t.muted }}>
              {"Configurable depuis Réglages > Paiements en ligne"}
            </p>
          </div>
          <Link to="/reglages/paiements"
