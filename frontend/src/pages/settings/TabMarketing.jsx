...
import { api, loyaltyApi, promoApi, clientsApi, campaignsApi, paymentsApi, birthdayApi, referralsApi, marketingApi } from '../../utils/api';
...
// email transactionnel d'invitation aux clients pending. Visible en tête du
// Marketing tab pour que le commerçant sache combien de clients il peut
// VRAIMENT toucher (filtre `marketing_opt_in=TRUE` appliqué SQL-level).
// ═══════════════════════════════════════════════════════════════════════════
function OptInBanner({ theme, showToast }) {
  ...
  // Si tout le monde est opt-in OU aucun client → pas de bannière
